...
norm_0 = keras.layers.BatchNormalization(axis=-1, momentum=0.5)(convolve_0)
act_0 = keras.layers.LeakyReLU(alpha=0.2)(norm_0)

convolve_1 = keras.layers.Conv2D(64, kernel_size, strides=(2, 2), padding='same', data_format='channels_last')(act_0)
norm_1 = keras.layers.BatchNormalization(axis=-1, momentum=0.5)(convolve_1)
act_1 = keras.layers.LeakyReLU(alpha=0.2)(norm_1)

convolve_2 = keras.layers.Conv2D(128, kernel_size, strides=(2, 2), padding='same', data_format='channels_last')(act_1)
norm_2 = keras.layers.BatchNormalization(axis=-1, momentum=0.5)(convolve_2)
act_2 = keras.layers.LeakyReLU(alpha=0.2)(norm_2)

convolve_3 = keras.layers.Conv2D(256, kernel_size, strides=(2, 2), padding='same', data_format='channels_last')(act_2)
norm_3 = keras.layers.BatchNormalization(axis=-1, momentum=0.5)(convolve_3)
act_3 = keras.layers.LeakyReLU(alpha=0.2)(norm_3)

convolve_4 = keras.layers.Conv2D(512, kernel_size, strides=(2, 2), padding='same', data_format='channels_last')(act_3)
norm_4 = keras.layers.BatchNormalization(axis=-1, momentum=0.5)(convolve_4)
act_4 = keras.layers.LeakyReLU(alpha=0.2)(norm_4)

convolve_5 = keras.layers.Conv2D(512, kernel_size, strides=(2, 2), padding='same', data_format='channels_last')(act_4)
norm_5 = keras.layers.BatchNormalization(axis=-1, momentum=0.5)(convolve_5)
act_5 = keras.layers.LeakyReLU(alpha=0.2)(norm_5)
...
norm_6 = keras.layers.BatchNormalization(axis=-1, momentum=0.5)(deconvolve_6)
act_6 = keras.layers.LeakyReLU(alpha=0.0)(norm_6)
...
norm_7 = keras.layers.BatchNormalization(axis=-1, momentum=0.5)(deconvolve_5)
act_7 = keras.layers.LeakyReLU(alpha=0.0)(norm_7)
...
norm_8 = keras.layers.BatchNormalization(axis=-1, momentum=0.5)(deconvolve_4)
act_8 = keras.layers.LeakyReLU(alpha=0.0)(norm_8)
...
norm_9 = keras.layers.BatchNormalization(axis=-1, momentum=0.5)(deconvolve_3)
act_9 = keras.layers.LeakyReLU(alpha=0.0)(norm_9)
...
norm_10 = keras.layers.BatchNormalization(axis=-1, momentum=0.5)(deconvolve_2)
act_10 = keras.layers.LeakyReLU(alpha=0.0)(norm_10)
...
norm_11 = keras.layers.BatchNormalization(axis=-1, momentum=0.5)(deconvolve_1)
act_11 = keras.layers.LeakyReLU(alpha=0.0)(norm_11)
