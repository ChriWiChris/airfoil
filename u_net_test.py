...
## downsampling layers ##
convolve_0 = keras.layers.Conv2D(64//factor, kernel_size, strides=(1, 1), padding='same', data_format='channels_last')(input_layer)
act_0 = keras.layers.LeakyReLU(alpha=0.2)(convolve_0)

convolve_1 = keras.layers.Conv2D(64//factor, kernel_size, strides=(2, 2), padding='same', data_format='channels_last')(act_0)
act_1 = keras.layers.LeakyReLU(alpha=0.2)(convolve_1)

convolve_2 = keras.layers.Conv2D(128//factor, kernel_size, strides=(2, 2), padding='same', data_format='channels_last')(act_1)
act_2 = keras.layers.LeakyReLU(alpha=0.2)(convolve_2)

convolve_3 = keras.layers.Conv2D(256//factor, kernel_size, strides=(2, 2), padding='same', data_format='channels_last')(act_2)
act_3 = keras.layers.LeakyReLU(alpha=0.2)(convolve_3)

convolve_4 = keras.layers.Conv2D(512//factor, kernel_size, strides=(2, 2), padding='same', data_format='channels_last')(act_3)
act_4 = keras.layers.LeakyReLU(alpha=0.2)(convolve_4)

convolve_5 = keras.layers.Conv2D(512//factor, kernel_size, strides=(2, 2), padding='same', data_format='channels_last')(act_4)
act_5 = keras.layers.LeakyReLU(alpha=0.2)(convolve_5)

convolve_6 = keras.layers.Conv2D(512//factor, kernel_size, strides=(2, 2), padding='same', data_format='channels_last')(act_5)
...
deconvolve_6 = keras.layers.Conv2D(512//factor, kernel_size, strides=(1, 1), padding='same', data_format='channels_last')(merged_6)
...
deconvolve_5 = keras.layers.Conv2D(256//factor, kernel_size, strides=(1, 1), padding='same', data_format='channels_last')(merged_5)
...
deconvolve_4 = keras.layers.Conv2D(128//factor, kernel_size, strides=(1, 1), padding='same', data_format='channels_last')(merged_4)
...
deconvolve_3 = keras.layers.Conv2D(64//factor, kernel_size, strides=(1, 1), padding='same', data_format='channels_last')(merged_3)
...
deconvolve_2 = keras.layers.Conv2D(64//factor, kernel_size, strides=(1, 1), padding='same', data_format='channels_last')(merged_2)
...
deconvolve_1 = keras.layers.Conv2D(64//factor, kernel_size, strides=(1, 1), padding='same', data_format='channels_last')(upsample_1)
