...
# subtract for each sample the mean pressure and devide by max
...
### train the network ###
history = model.fit(data_input, data_target, epochs=100, batch_size=1, validation_data=(val_input, val_target))
